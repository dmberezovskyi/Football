...
function ComingSoonView({className}) {
  const classes = useStyles();
  const countdown = useCountdown(new Date('07/07/2022 21:30'));

  return (
    <Page title="Coming Soon!" className={classes.root}>
      ...
      <Container>
        <Box sx={{ maxWidth: 480, margin: 'auto', textAlign: 'center' }}>
          ...
          <div className={clsx(classes.countdownRoot, className)}>
            <div>
            ...
            <Typography variant="h2" className={classes.CountdownMargin}>
              :
            </Typography>
